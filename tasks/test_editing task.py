...
def test_tt():
    ...
    time.sleep(2)
    browser.element("//button[@type='button' and contains(@class, 'Calendar_day__xh0IC') and text()='30']").click()
    time.sleep(2)
    browser.element("//button[text()='OK']").click()
    browser.element("//button[@type='button’ and normalize-space(.)=‘Сохранить’]").click()
    time.sleep(2)
